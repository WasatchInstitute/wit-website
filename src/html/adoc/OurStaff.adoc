            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    <li class="sidebar-brand">
                        <a href="#_staff_bios">Staff bios</a>
                    </li>
                    <li class="sidebar-brand">
                        <a href="#_teaching_team_responsibilities">Teaching team responsibilities</a>
                    </li>
                    <li class="sidebar-brand">
                        <a href="#_board_of_directors">Board of Directors</a>
                    </li>
                    <li class="sidebar-brand">
                        <a href="#_working_at_wit">Working at WIT</a>
                    </li>
                </ul>
            </div>
++++
