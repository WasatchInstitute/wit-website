...
Rather than bemoan the declining capabilities, he worked to establish a computer science-focused high school accessible to as many students as possible. Combining his expertise as a network administrator, software developer, and ScrumMaster, David adapted the Agile software development methodology for education. The result is a <<NextGeneration.adoc#_Next_Generation_Education,unique learning environment found nowhere else>>. 
