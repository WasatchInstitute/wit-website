       ...
       <div id="wrapper">
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-brand">
                        <a href="#_replacement_fees">Replacement Fees</a>
                    </li>
                    <li class="sidebar-brand">
...
== Replacement Fees
Currently, the replacement fee for a UTA Transit pass is $10. This fee can be handled in the main office during <<ContactInformation.adoc#Hours of Operation,office hours>>.
